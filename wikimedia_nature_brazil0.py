...
CATEGORIAS_NATUREZA = [
    "satellite",                   # Imagens satelitares (muitas com GPS)
    "floresta",                   # Imagens de desmatamento no Brasil (muitas com GPS)  
    "trees",                   # Imagens de natureza no Brasil (muitas com GPS)
    "Cameraman",
