...
## Estrutura
Uma árvore por combo `<linguagem>.<idioma>/` (presentes: cpp.en, cpp.es, cpp.fr, cpp.it, cpp.pt, py.en, py.es, py.fr, py.it, py.pt):
...
## Como usar
```bash
jupyter lab cpp.it/cap01/cap01_aluno.ipynb
```
