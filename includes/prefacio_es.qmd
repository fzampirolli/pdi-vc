...
: Número de páginas del PDF y tiempo de renderizado por combinación (paralelismo real medio de ~5 procesos, pico de 8). La combinación base en Python/Portugués solo renderiza las salidas ya registradas en los *notebooks*-fuente; las demás reejecutan todo el código. {#tbl-00-tempos}
