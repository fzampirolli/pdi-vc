...
| :--- | :--- | :--- | ---: | ---: |
| `py.pt` | Python | Portugués (base) | 652 | ~8 min |
| `py.en` | Python | Inglés | 642 | ~32 min |
| `py.fr` | Python | Francés | 664 | ~32 min |
| `py.es` | Python | Español¹ | 666 | ~80 min |
| `py.it` | Python | Italiano¹ | 658 | ~80 min |
| `cpp.pt` | C++ | Portugués | 426 | ~28 min |
| `cpp.en` | C++ | Inglés | 418 | ~32 min |
| `cpp.fr` | C++ | Francés | 426 | ~22 min |
