...
L'ouvrage est publié en plusieurs **combinaisons** — chaque piste de code (**Python** et **C++**) dans chaque langue. Une régénération complète à partir de zéro (traduction avec cache, réexécution des *notebooks*, rendu HTML et PDF, et publication) prend environ **40 minutes** lorsqu'elle est traitée en parallèle avec quatre processus simultanés. Le @tbl-00-tempos détaille le temps de rendu de chaque combinaison.

| Combinaison | Piste  | Langue             | Temps de rendu |
| :---------- | :----- | :----------------- | -------------: |
| `py.pt`     | Python | Portugais (base)   | ~8 min         |
| `py.en`     | Python | Anglais            | ~32 min        |
| `py.fr`     | Python | Français           | ~32 min        |
| `cpp.pt`    | C++    | Portugais          | ~28 min        |
| `cpp.en`    | C++    | Anglais            | ~32 min        |
| `cpp.fr`    | C++    | Français           | ~22 min        |

: Temps de rendu par combinaison lors d'une régénération complète, avec quatre processus en parallèle. La combinaison de base Python/Portugais ne fait que rendre les sorties déjà enregistrées dans les *notebooks* source ; les autres réexécutent tout le code. Le temps total (horloge murale), y compris l'assemblage de l'index et la publication, avoisine les **38 minutes**. {#tbl-00-tempos}
