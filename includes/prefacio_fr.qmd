...
| :--- | :--- | :--- | ---: | ---: |
| `py.pt` | Python | Portugais (base) | 654 | ~7 min |
| `py.en` | Python | Anglais | 644 | ~31 min |
| `py.fr` | Python | Français | 666 | ~31 min |
| `py.es` | Python | Espagnol | 666 | ~31 min |
| `py.it` | Python | Italien | 658 | ~31 min |
| `cpp.pt` | C++ | Portugais | 434 | ~26 min |
| `cpp.en` | C++ | Anglais | 426 | ~34 min |
| `cpp.fr` | C++ | Français | 434 | ~38 min |
| `cpp.es` | C++ | Espagnol | 430 | ~37 min |
| `cpp.it` | C++ | Italien | 428 | ~35 min |

: Nombre de pages du PDF et temps de rendu par combinaison (parallélisme réel moyen de ~5 processus, pic de 8). La combinaison de base Python/Portugais ne fait que rendre les sorties déjà enregistrées dans les *notebooks* source ; les autres réexécutent tout le code. {#tbl-00-tempos}
