...
| :--- | :--- | :--- | ---: | ---: |
| `py.pt` | Python | Portugais (base) | 652 | ~8 min |
| `py.en` | Python | Anglais | 642 | ~32 min |
| `py.fr` | Python | Français | 664 | ~32 min |
| `py.es` | Python | Espagnol¹ | 666 | ~80 min |
| `py.it` | Python | Italien¹ | 658 | ~80 min |
| `cpp.pt` | C++ | Portugais | 426 | ~28 min |
| `cpp.en` | C++ | Anglais | 418 | ~32 min |
| `cpp.fr` | C++ | Français | 426 | ~22 min |
