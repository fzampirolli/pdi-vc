...
| :--- | :--- | :--- | ---: | ---: |
| `py.pt` | Python | Portuguese (base) | 652 | ~8 min |
| `py.en` | Python | English | 642 | ~32 min |
| `py.fr` | Python | French | 664 | ~32 min |
| `py.es` | Python | Spanish¹ | 666 | ~80 min |
| `py.it` | Python | Italian¹ | 658 | ~80 min |
| `cpp.pt` | C++ | Portuguese | 426 | ~28 min |
| `cpp.en` | C++ | English | 418 | ~32 min |
| `cpp.fr` | C++ | French | 426 | ~22 min |
