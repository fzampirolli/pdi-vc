...
| :--- | :--- | :--- | ---: | ---: |
| `py.pt` | Python | Portoghese (base) | 652 | ~8 min |
| `py.en` | Python | Inglese | 642 | ~32 min |
| `py.fr` | Python | Francese | 664 | ~32 min |
| `py.es` | Python | Spagnolo¹ | 666 | ~80 min |
| `py.it` | Python | Italiano¹ | 658 | ~80 min |
| `cpp.pt` | C++ | Portoghese | 426 | ~28 min |
| `cpp.en` | C++ | Inglese | 418 | ~32 min |
| `cpp.fr` | C++ | Francese | 426 | ~22 min |
