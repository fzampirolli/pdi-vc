...
L'opera è pubblicata in **dieci combinazioni** — ogni percorso di codice (**Python** e **C++**) in cinque lingue (portoghese, inglese, francese, spagnolo e italiano). Con la cache di traduzione già popolata, una rigenerazione completa (traduzione, riesecuzione dei *notebook*, rendering di HTML e PDF e pubblicazione) richiede circa **45 minuti** con quattro processi in parallelo; la **prima** generazione di una nuova lingua, con la cache vuota, è molto più lenta — circa **80 minuti** per combinazione, come osservato nelle prime generazioni di spagnolo e italiano. La @tbl-00-tempos riassume ogni combinazione (con la cache già popolata): numero di pagine del PDF e tempo di rendering.
...
::: {.callout-note}
### Altri percorsi e lingue {.unnumbered}
