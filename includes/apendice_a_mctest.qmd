...
O **MCTest** é um sistema de código aberto para criação e correção automática de exames parametrizados [@zampirolli2023mctest]. Ele oferece suporte a questões de múltipla escolha, dissertativas e de programação, estas últimas integradas ao VPL do Moodle, descrito no [Apêndice B](#apendice-moodle).

A versão do MCTest utilizada neste livro é a **5.4**, disponível em https://github.com/fzampirolli/mctest. A subpasta `book` do repositório contém as versões **5.3**, descrita em [@zampirolli2023mctest], e **5.4**, utilizada para gerar as provas apresentadas neste livro e atualmente em produção na UFABC ([https://mctest.ufabc.edu.br](https://mctest.ufabc.edu.br)).
