...
| :--------- | :----- | :--------------- | ------: | ---------------: |
| `py.pt`    | Python | Português (base) |     652 | ~8 min           |
| `py.en`    | Python | Inglês           |     642 | ~32 min          |
| `py.fr`    | Python | Francês          |     664 | ~32 min          |
| `py.es`    | Python | Espanhol¹        |     666 | ~80 min          |
| `py.it`    | Python | Italiano¹        |     658 | ~80 min          |
| `cpp.pt`   | C++    | Português        |     426 | ~28 min          |
| `cpp.en`   | C++    | Inglês           |     418 | ~32 min          |
| `cpp.fr`   | C++    | Francês          |     426 | ~22 min          |
