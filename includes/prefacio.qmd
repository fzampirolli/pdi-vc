...
O conteúdo desta edição foi elaborado entre maio e julho de 2026, durante a oferta da disciplina de Processamento Digital de Imagens em duas turmas de graduação — majoritariamente de estudantes de Ciência da Computação, no período matutino — e em uma turma de pós-graduação em Ciência da Computação, todas na UFABC.
