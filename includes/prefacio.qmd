...
Distinto do uso editorial descrito acima, o *pipeline* de geração multi-idioma (ver "Como este livro é produzido") emprega um modelo de linguagem como **componente de engenharia do sistema**: a tradução automática do conteúdo entre português e outros idiomas, com cache incremental que evita retraduzir trechos inalterados. Essa etapa usa a **API paga da Anthropic** (modelo `claude-sonnet-5`); o livro completo já foi traduzido do português para o **inglês** e o **francês**, e o Capítulo 1 conta ainda com uma trilha em **C++** que compila e executa de verdade — tudo a um custo baixo, da ordem de poucos dólares, graças ao cache incremental.
