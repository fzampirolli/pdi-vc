...
A obra é publicada em **dez combinações** — cada trilha de código (**Python**, 9 capítulos; **C++**, capítulos 1 a 5) em cinco idiomas (Português, Inglês, Francês, Espanhol e Italiano). Com o cache de tradução já povoado, uma regeneração completa (tradução, reexecução dos *notebooks*, renderização de HTML e PDF e publicação) leva cerca de **45 minutos** com quatro processos em paralelo; a **primeira** geração de um idioma novo, com o cache vazio, é bem mais lenta. A @tbl-00-tempos resume cada combinação: número de páginas do PDF e tempo de renderização.

| Combinação | Trilha | Idioma           | Páginas | Tempo de render. |
| :--------- | :----- | :--------------- | ------: | ---------------: |
| `py.pt`    | Python | Português (base) |     654 | ~8 min           |
| `py.en`    | Python | Inglês           |     644 | ~32 min          |
| `py.fr`    | Python | Francês          |     666 | ~32 min          |
| `py.es`    | Python | Espanhol¹        |     668 | ~80 min          |
| `py.it`    | Python | Italiano¹        |     658 | ~80 min          |
| `cpp.pt`   | C++    | Português        |     434 | ~28 min          |
| `cpp.en`   | C++    | Inglês           |     426 | ~32 min          |
| `cpp.fr`   | C++    | Francês          |     434 | ~22 min          |
| `cpp.es`   | C++    | Espanhol         |     430 | ~35 min          |
| `cpp.it`   | C++    | Italiano         |     426 | ~35 min          |

: Páginas do PDF e tempo de renderização por combinação (quatro processos em paralelo). A combinação-base em Python/Português apenas renderiza as saídas já registradas nos *notebooks*-fonte; as demais reexecutam todo o código. ¹ Primeira geração do idioma, com o cache de tradução vazio: cada trecho de texto é traduzido do zero, o que torna a geração inicial bem mais lenta que as re-gerações seguintes. {#tbl-00-tempos}
