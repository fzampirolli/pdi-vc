...
### Configurando a aplicação no *SEB Tool* {.unnumbered}
...
### Vinculando a chave do SEB à atividade VPL no Moodle {.unnumbered}
...
#### Restrição por endereço IP (opcional) {.unnumbered}
